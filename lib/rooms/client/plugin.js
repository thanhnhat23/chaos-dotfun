...
class RoomsPlugin extends PluginInterface
{
    ...
    populateSceneSelector(roomSelection, gameManager)
    {
        ...
        if(playerCreationAdditional){
            playerCreationAdditional.querySelectorAll('.chaos-room-selector-creation').forEach((node) => node.remove());
            ...
            div.classList.add('chaos-room-selector-creation');
            playerCreationAdditional.append(div);
        }
        if(playerSelectionAdditional){
            playerSelectionAdditional.querySelectorAll('.chaos-room-selector-selection').forEach((node) => node.remove());
            let div = this.createSelectorElements(gameManager, roomSelection, 'selection');
            div.classList.add('chaos-room-selector-selection');
    ...
    createSelectorElements(gameManager, roomSelection, key)
    {
        ...
        div.classList.add('chaos-room-selector');
